...
const META: Record<Architecture, { label: string; icon: typeof Layers; className: string }> = {
  ...
  skills: { label: "Skills", icon: Layers, className: "bg-blue-100 text-blue-700 border-blue-200" },
  agentic: { label: "Agentic", icon: Workflow, className: "bg-emerald-100 text-emerald-700 border-emerald-200" },
};
